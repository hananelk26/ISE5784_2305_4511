...
public class MultiObjectImageTests {
    ...
    private final Polygon grass0 = (Polygon) new Polygon(
            ...
            new Point(550, -200, -400)).setMaterial(new Material().setKR(0).setKs(0.2).setKT(0).setShininess(5000).setKd(0.5)); // Dark green

    private final Polygon grass1 = (Polygon) new Polygon(
            new Point(120, -200, 0),
            new Point(200, -200, 0),
            new Point(550, -200, -400),
            new Point(350, -200, -400)).setMaterial(new Material().setKR(0).setKs(0.2).setKT(0).setShininess(5000).setKd(0.8));

    private final Polygon grass2 = (Polygon) new Polygon(
            new Point(40, -200, 0),
            new Point(120, -200, 0),
            new Point(350, -200, -400),
            new Point(150, -200, -400)).setMaterial(new Material().setKR(0).setKs(0.2).setKT(0).setShininess(5000).setKd(0.5)); // Dark green

    private final Polygon grass3 = (Polygon) new Polygon(
            new Point(-40, -200, 0),
            new Point(40, -200, 0),
            new Point(150, -200, -400),
            new Point(-50, -200, -400)).setMaterial(new Material().setKR(0).setKs(0.2).setKT(0).setShininess(5000).setKd(0.8)); // Adjusted Z coordinate to be on the same plane

    private final Polygon grass4 = (Polygon) new Polygon(
            new Point(-120, -200, 0),
            new Point(-40, -200, 0),
            new Point(-50, -200, -400),
            new Point(-250, -200, -400) ).setMaterial(new Material().setKR(0).setKs(0.2).setKT(0).setShininess(5000).setKd(0.5)); // Adjusted Z coordinate to be on the same plan

    private final Polygon grass5 = (Polygon) new Polygon(
            new Point(-200, -200, 0),
            new Point(-120, -200, 0),
            new Point(-250, -200, -400),
            new Point(-450, -200, -400)).setMaterial(new Material().setKR(0).setKs(0.2).setKT(0).setShininess(5000).setKd(0.8));
    ...
    private final Polygon grass6 = (Polygon) new Polygon(
            ...
            new Point(-650, -200, -400)).setMaterial(new Material().setKR(0).setKs(0.2).setKT(0).setShininess(5000).setKd(0.5));
