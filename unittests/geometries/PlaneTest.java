...
class PlaneTest {
    ...
    public void testFindIntsersections(){
        ...
        assertEquals(List.of(new Point(0,1,2)),plane.findIntsersections(ray1),"The function findIntsersections returns an incorrect breakpoint.");
        ...
        assertNull(plane.findIntsersections(ray4),"The line is parallel to the plane and the function findIntsersections does not return null.");
        ...
        assertEquals(List.of(new Vector(0,1,2)),plane.findIntsersections(ray5),"The function findIntsersections returns an incorrect breakpoint.");
        ...
        assertNull(plane.findIntsersections(ray6),"The function findIntsersections returns an incorrect breakpoint.");
        ...
        assertNull(plane.findIntsersections(ray7),"The function returns an intersection point even though the ray line starts from the plane");
        ...
        assertNull(plane.findIntsersections(ray8),"The function returns an intersection point even though the ray line starts from the plane");

        //TC15: checks case that the ray start from the plane (0 points)
        Ray ray9 =  new Ray(new Point(0,1,2),new Vector(2,-13,5));
        assertNull(plane.findIntsersections(ray9),"The function returns an intersection point even though the ray line starts from the plane");
    }
}